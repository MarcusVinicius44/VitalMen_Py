...
from backend.controllers import post_controller, tarefa_controller, user_controller, listas_controller, comments
...
FRONT_DIR = os.path.abspath(os.path.join(os.path.dirname(_file_), '..', 'frontend'))
